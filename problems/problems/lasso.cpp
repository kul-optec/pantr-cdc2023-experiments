...
struct Problem {
    ...
    Problem(const LassoProblemConfig &conf) : config{conf} {
        // Functions
...
benchmark_problem_register(void *user_data) {
    ...
    auto *problem = new Problem{LassoProblemConfig{.sc = user_config.size}};
