...
struct Problem {
    ...
    Problem(const RegrProblemConfig &conf) : config{conf} {
        // Functions
...
benchmark_problem_register(void *user_data) {
    ...
    auto *problem = new Problem{RegrProblemConfig{.sc = user_config.size}};
