...
if formulation == "ocp":
    ...
    with open(f"{name}.tsv", "w") as f:
        np.savetxt(f, ss.C, delimiter="\t", newline="\n")
        np.savetxt(f, ss.D, delimiter="\t", newline="\n")
        np.savetxt(f, [ss.initial_state], delimiter="\t", newline="\n")
    ...
    with open(f"{name}.tsv", "w") as f:
        np.savetxt(f, ms.C, delimiter="\t", newline="\n")
        np.savetxt(f, ms.D, delimiter="\t", newline="\n")
        np.savetxt(f, [ms.initial_state], delimiter="\t", newline="\n")
