...
#include <alpaqa/inner/true-fbe-trust.hpp>
...
PARAMS_TABLE(PowellParams<config_t>, //
             PARAMS_MEMBER(damped),  //
             PARAMS_MEMBER(σ2),      //
             PARAMS_MEMBER(σ3),      //
);
...
PARAMS_TABLE(FBETrustParams<config_t>,                                  //
...
PARAMS_TABLE(TRDirectionParams<config_t>,           //
             PARAMS_MEMBER(rescale_when_γ_changes), //
             PARAMS_MEMBER(exact_newton),           //
             PARAMS_MEMBER(hessian_vec_factor),     //
             PARAMS_MEMBER(cauchy_point),           //
             PARAMS_MEMBER(steihaug_params),        //
);
...
template void set_params(PANOCParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(ZeroFPRParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(FBETrustParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(TrueFBETrustParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(LBFGSParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(LBFGSDirectionParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(StructuredLBFGSDirectionParams<config_t> &,
                         std::string_view, std::span<const std::string_view>);
template void set_params(TRDirectionParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(StructuredNewtonDirectionParams<config_t> &,
                         std::string_view, std::span<const std::string_view>);
template void set_params(ALMParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(length_t<config_t> &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(std::string_view &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(std::string &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(bool &, std::string_view,
                         std::span<const std::string_view>);
template void set_params(vec<config_t> &, std::string_view,
                         std::span<const std::string_view>);
#if ALPAQA_WITH_OCP
template void set_params(PANOCOCPParams<config_t> &, std::string_view,
                         std::span<const std::string_view>);
#endif
