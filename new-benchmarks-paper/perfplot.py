...
def print_solver_info(results):
    ...
    is_res_name = lambda e: e.startswith("results_name=")
    get_opts = lambda res: tuple(e for e in res['opts'] if not is_res_name(e))
    opts = set(get_opts(res) for res in results)
